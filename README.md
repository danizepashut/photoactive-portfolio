...
מפורש דרך `/admin/students/[id]`. האוטומציות (תזכורות, הזמנת וואטסאפ,
הודעות פרסום) עדיין לא נבנו — זה שלב שש, וכולל גם את ה-cron שיעביר
תלמידים ל-`not_submitted` אוטומטית כשחלון ה-7 ימים חולף.
